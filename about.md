...
### A Printable Resume
Get a resume that's consistent across the board — whether it's on the web, mobile, print, or [PDF](https://github.com/JorgeRamos01/jorgeramos01.github.io/blob/master/assets/Resume.pdf).
